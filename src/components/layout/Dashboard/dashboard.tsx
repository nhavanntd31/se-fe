...
import { getSemesters, getStatistic, GetStatisticInfoDto, StatisticResponse } from "@/services/statistic.service";
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between">
          <h2 className="text-3xl font-bold tracking-tight">Trường Điện - Điện tử</h2>
          <DateRangePicker 
